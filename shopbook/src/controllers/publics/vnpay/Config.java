 ...
 */
package controllers.publics.vnpay;
...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:8088/shopbook/views/public/vnpay/vnpay_return.jsp";
    public static String vnp_TmnCode = "Y4U88XFK";
    public static String vnp_HashSecret = "DTHXNFNBUMNKFKQOZVHTXUXNUQUUXMTV";
    ...
    public static String hashAllFields(Map fields) throws UnsupportedEncodingException {
        ...
        sb.append(controllers.publics.vnpay.Config.vnp_HashSecret);
