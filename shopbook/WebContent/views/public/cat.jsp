                ...
                <div class="col-lg-9 col-md-7">
                    ...
                    <div class="row">
                    	<%
	                    	...
	                    	int catId = 0, total = 0, pages = 1, totalPages = 1;
                    ...
                    <div class="product__pagination">
                    	<%
							if (pages > 1) {
								int back = pages - 1;
								String urlPage = request.getContextPath() + "/danh-muc-san-pham-" + category.getId() + "/" + StringUtil.makeSlug(category.getName()) + "/" + back;
					    %>
					    <a href="<%=urlPage %>"><i class="fa fa-long-arrow-left"></i></a>
					    <%
							}
	                        for (int j = 1; j <= totalPages; j++) {
	                        	String urlPage = request.getContextPath() + "/danh-muc-san-pham-" + category.getId() + "/" + StringUtil.makeSlug(category.getName()) + "/" + j;
	                    		if (pages == j) {
					    %>
	                    ...
	                    <%
	                        ...
	                        if (pages < totalPages) {
	                        	int next = pages + 1;
	                        	String urlPage = request.getContextPath() + "/danh-muc-san-pham-" + category.getId() + "/" + StringUtil.makeSlug(category.getName()) + "/" + next;
                        %>
